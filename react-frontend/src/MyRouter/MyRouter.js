...
import SingleTrainingMaterialPage from "../components/app_components/TrainingMaterialPage/SingleTrainingMaterialPage";
import TrainingMaterialProjectLayoutPage from "../components/app_components/TrainingMaterialPage/TrainingMaterialProjectLayoutPage";
import SingleTrainingCoursePage from "../components/app_components/TrainingCoursePage/SingleTrainingCoursePage";
import TrainingCourseProjectLayoutPage from "../components/app_components/TrainingCoursePage/TrainingCourseProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/trainingMaterial/:singleTrainingMaterialId" exact element={<SingleTrainingMaterialPage />} />
<Route path="/trainingMaterial" exact element={<TrainingMaterialProjectLayoutPage />} />
<Route path="/trainingCourse/:singleTrainingCourseId" exact element={<SingleTrainingCoursePage />} />
<Route path="/trainingCourse" exact element={<TrainingCourseProjectLayoutPage />} />
