...
import seederData from "./trainingCourse.seeder.json";
...
const TrainingCourseSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TrainingCourseSeederDialogComponent);
