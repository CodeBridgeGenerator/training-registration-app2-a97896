...
const SingleTrainingMaterialPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleTrainingMaterialId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleTrainingMaterialId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Training Material</h3>
                    <SplitButton
                ...
                {/* <p>trainingMaterial/{urlParams.singleTrainingMaterialId}</p> */}
            </div>
...
<div className="col-12"><label className="text-sm text-gray-600">File Upload</label><div className="m-0 ml-3" ><UploadFilesToS3 type={'single'}/></div></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3"  dangerouslySetInnerHTML={{__html: _entity?.description}}></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleTrainingMaterialId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleTrainingMaterialPage);
