...
import seederData from "./trainingMaterial.seeder.json";
...
const TrainingMaterialSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TrainingMaterialSeederDialogComponent);
