...
const trainingMaterial = require("./trainingMaterial/trainingMaterial.service.js");
const trainingCourse = require("./trainingCourse/trainingCourse.service.js");
...
module.exports = function (app) {
  ...
  app.configure(trainingMaterial);
  app.configure(trainingCourse);
